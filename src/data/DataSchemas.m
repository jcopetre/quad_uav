    ...
    methods (Static)
        ...
        function schema = SimulationResult()
            ...
            schema.optional = {
                ...
                'params_plant', % Plant parameters (for MC with perturbed dynamics)
        ...
        function schema = TrajectoryData()
            ...
            schema.optional = {
                ...
                'waypoints',         % Original waypoint structure used
                'feasibility',        % Trajectory feasibility check results (struct)
                'filename',          % wpt filename used for study 
            };
