...
function generate_vehicle_slx()
    ...
    % Automated Simulink Model Builder for Quadrotor 6DOF
% This script creates the complete Simulink model programmatically
% Saves model to ./vehicle/ directory
...
function build_simulink_model()
    ...
    model_name = 'quadrotor_6dof_lqr';
    model_path = './vehicle/quadrotor_6dof_lqr';
    
    % Create vehicle directory if it doesn't exist
    if ~exist('./vehicle', 'dir')
        mkdir('./vehicle');
        fprintf('  Created ./vehicle directory\n');
    end
